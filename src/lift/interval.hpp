...
namespace lift
{
  ...
  namespace detail
  {
    ...
    inline double acos_down(const double& x) { return nextafter(acos(x), 0); }
    inline double acos_up(const double& x) { return nextafter(acos(x), 4); }
    inline double acosh_down(const double& x) { return nextafter(acosh(x), 0); }
    inline double acosh_up(const double& x) { return nextafter(acosh(x), std::numeric_limits<double>::infinity()); }
    inline double atan_down(const double& x) { return nextafter(atan(x), -2); }
    inline double atan_up(const double& x) { return nextafter(atan(x), 2); }
    inline double atanh_down(const double& x) { return nextafter(atan(x), -std::numeric_limits<double>::infinity()); }
    inline double atanh_up(const double& x) { return nextafter(atan(x), std::numeric_limits<double>::infinity()); }
    inline double asin_down(const double& x) { return nextafter(asin(x), -2); }
    inline double asin_up(const double& x) { return nextafter(asin(x), 2); }
    inline double asinh_down(const double& x) { return nextafter(asinh(x), -std::numeric_limits<double>::infinity()); }
    inline double asinh_up(const double& x) { return nextafter(asinh(x), std::numeric_limits<double>::infinity()); }
    inline double cos_down(const double& x) { return nextafter(cos (x), -1); }
    inline double cos_up(const double& x) { return nextafter(cos (x), 1); }
    inline double cosh_down(const double& x) { return nextafter(cosh(x), 1); }
    inline double cosh_up(const double& x) { return nextafter(cosh(x), std::numeric_limits<double>::infinity()); }
    inline double exp_down(const double& x) { return nextafter(exp (x), 0); }
    inline double exp_up(const double& x) { return nextafter(exp (x), std::numeric_limits<double>::infinity()); }
    inline double log_down(const double& x) { return nextafter(log (x), -std::numeric_limits<double>::infinity()); }
    inline double log_up(const double& x) { return nextafter(log (x), std::numeric_limits<double>::infinity()); }
    inline double sin_down(const double& x) { return nextafter(sin (x), -1); }
    inline double sin_up(const double& x) { return nextafter(sin (x), 1); }
    inline double sinh_down(const double& x) { return nextafter(sinh(x), -std::numeric_limits<double>::infinity()); }
    inline double sinh_up(const double& x) { return nextafter(sinh(x), std::numeric_limits<double>::infinity()); }
    inline double sqrt_down(const double& x) { return nextafter(sqrt(x), 0); }
    inline double sqrt_up(const double& x) { return nextafter(sqrt(x), std::numeric_limits<double>::infinity()); }
    inline double tan_down(const double& x) { return nextafter(tan (x), -std::numeric_limits<double>::infinity()); }
    inline double tan_up(const double& x) { return nextafter(tan (x), std::numeric_limits<double>::infinity()); }
    inline double tanh_down(const double& x) { return nextafter(tanh(x), -1); }
    inline double tanh_up(const double& x) { return nextafter(tanh(x), 1); }
